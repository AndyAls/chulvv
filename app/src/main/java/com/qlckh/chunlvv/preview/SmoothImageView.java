...
public class SmoothImageView extends PhotoView {
    ...
    private static int TRANSFORM_DURATION = 100;
    ...
    private void initTransform() {
        ...
        startTransform.top = thumbRect.top - getStatusBarHeight(getContext().getApplicationContext());
    ...
    public int getStatusBarHeight(Context mApplicationContent) {
        int result = mApplicationContent.getResources().getDimensionPixelSize(R.dimen.dp25);
