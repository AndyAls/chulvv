...
public class Scan1Activity extends Activity {
        ...
        switch (type) {
            ...
            case URI:
                ...
                if (resultString != null) {
                    if (getIntent().getAction().equals("andy")){
                        setResult(RESULT_OK,getIntent().putExtra("andy",resultString));
                        finish();
                        return;
                    }
                }

                Intent intent = new Intent(Scan1Activity.this,WebViewActivity.class);
            ...
            case TEXT:
                ...
                if (result != null) {
                    ...
                    runOnUiThread(() -> showDialog(finalResultString));
                }else {
